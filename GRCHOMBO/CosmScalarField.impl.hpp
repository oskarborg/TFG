...
#if !defined(COSMSCALARFIELD_HPP_)
#error "This file should only be included through CosmScalarField.hpp"
#endif

#ifndef COSMSCALARFIELD_IMPL_HPP_
#define COSMSCALARFIELD_IMPL_HPP_

// Calculate the stress energy tensor elements
template <class potential_t>
template <class data_t, template <typename> class vars_t>
emtensor_t<data_t> CosmScalarField<potential_t>::compute_emtensor(
...
template <class potential_t>
template <class data_t, template <typename> class vars_t>
void CosmScalarField<potential_t>::emtensor_excl_potential(
...
void CosmScalarField<potential_t>::add_matter_rhs(
...
template <class data_t, template <typename> class vars_t,
          template <typename> class diff2_vars_t,
          template <typename> class rhs_vars_t>
void CosmScalarField<potential_t>::matter_rhs_excl_potential(
...
#endif /* COSMSCALARFIELD_IMPL_HPP_ */
