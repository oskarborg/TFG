...
#ifndef COSMSCALARFIELD_HPP_
#define COSMSCALARFIELD_HPP_
...
*/
template <class potential_t = DefaultPotential> class CosmScalarField
{
  protected:
  ...
  public:
    //!  Constructor of class CosmScalarField, inputs are the matter parameters.
    CosmScalarField(const potential_t a_potential) : my_potential(a_potential) {}
...
#include "CosmScalarField.impl.hpp"

#endif /* COSMSCALARFIELD_HPP_ */
